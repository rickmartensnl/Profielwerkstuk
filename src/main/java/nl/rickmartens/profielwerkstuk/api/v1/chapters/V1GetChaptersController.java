...
import nl.rickmartens.profielwerkstuk.api.v1.chapters.paragraphs.V1ParagraphsController;
import nl.rickmartens.profielwerkstuk.database.impl.ChapterManager;
...
public class V1GetChaptersController implements Controller {
    ...
    public V1GetChaptersController(@Nullable String uuid, HttpRequest httpRequest) {
        controllers.put("paragraphs", new V1ParagraphsController());
