                ...
                <div className="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
                    ...
                    <div className="bg-white dark:bg-dark-primary shadow w-full rounded-lg divide-y divide-gray-200 dark:divide-dark-tertiary">
                        <form onSubmit={this.handleLogin} className="px-5 py-7">
                            ...
                            <input name="email" type="text" value={this.state.email} onChange={this.handleChange} className={`border dark:border-dark-tertiary rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full dark:bg-dark-secondary ${this.state.isEmptyEmail || this.state.invalidEmail ? 'border-red-500' : ''}`} />
                            ...
                            <input name="password" type="password" value={this.state.password} onChange={this.handleChange} className={`border dark:border-dark-tertiary rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full dark:bg-dark-secondary ${this.state.isEmptyPassword ? 'border-red-500' : ''}`}/>
