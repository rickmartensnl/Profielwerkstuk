                ...
                <div className="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
                    ...
                    <div className="bg-white dark:bg-dark-primary shadow w-full rounded-lg divide-y divide-gray-200 dark:divide-dark-tertiary">
                        <form onSubmit={this.handleRegister} className="px-5 py-7">
                            ...
                            <label className={`font-semibold text-sm ${this.state.isEmptyUsername ? 'text-red-500' : 'text-gray-600 dark:text-dark-text-primary'} pb-1 block`}>Gebruikersnaam<span className="italic">{this.state.isEmptyUsername ? ' — This field is required' : ''}</span></label>
                            ...
                            <label className={`font-semibold text-sm ${this.state.isEmptyPassword ? 'text-red-500' : 'text-gray-600 dark:text-dark-text-primary'} pb-1 block`}>Wachtwoord<span className="italic">{this.state.isEmptyPassword ? ' — This field is required' : ''}</span></label>
                            ...
                            <label className={`font-semibold text-sm ${this.state.isEmptyPasswordConfirm || this.state.isNotMatchingPasswords ? 'text-red-500' : 'text-gray-600 dark:text-dark-text-primary'} pb-1 block`}>Verifieer Wachtwoord<span className="italic">{this.state.isEmptyPasswordConfirm ? ' — This field is required' : this.state.isNotMatchingPasswords ? ' — Passwords do not match' : ''}</span></label>
